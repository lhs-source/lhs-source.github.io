    ...
    <div class="project-content">
      ...
      <section class="tech-section">
        ...
        <div class="dto-diagram-section">
          ...
          <!-- <div class="dto-diagram">
            <div class="dto-flow">
              <div class="dto-box">
                <div class="dto-label">Frontend</div>
                <div class="dto-items">
                  <div class="dto-item">Request DTO</div>
                </div>
              </div>
              <div class="dto-arrow">→</div>
              <div class="dto-box">
                <div class="dto-label">API</div>
                <div class="dto-items">
                  <div class="dto-item">Request</div>
                  <div class="dto-item">Response</div>
                </div>
              </div>
              <div class="dto-arrow">→</div>
              <div class="dto-box">
                <div class="dto-label">Backend</div>
                <div class="dto-items">
                  <div class="dto-item">Response DTO</div>
                </div>
              </div>
            </div>
          </div> -->
