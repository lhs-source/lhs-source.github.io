      ...
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          >
            ...
            <span class="nav-item-period">{{ project.period }}</span>
          </div>
        </nav>
      </aside>
...
.portfolio2-wrapper {
  ...
  height: 100vh;
  color: #111111;
  font-family: 'Pretendard', 'Noto Serif KR', 'Noto Serif', serif;
  font-weight: 300;
